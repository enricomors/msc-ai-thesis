...
% TODO: Remove the outliers to better check the distribution of Emissions and Energy Consumptions

% TODO: explore the relationship between other metrics, e.g. check the correlations of cpu energy and ram energy with other variables (even if it should be almost the same as the totEnergy)
